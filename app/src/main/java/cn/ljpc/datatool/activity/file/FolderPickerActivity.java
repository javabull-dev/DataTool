package cn.ljpc.datatool.activity.file;
...
import cn.ljpc.datatool.activity.file.folderchoose.FilePojo;
import cn.ljpc.datatool.activity.file.folderchoose.FolderAdapter;
...
public class FolderPickerActivity extends AppCompatActivity {
    ...
    public void goBack(View v) {
        ...
        if (location != null && !location.equals("") && !location.equals("/") && !location.equals(path)) {
    ...
    void createNewFolder(String filename) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, "出错:" + e.toString(), Toast.LENGTH_LONG)
                    .show();
        }
    ...
    public void newFolderDialog(View v) {
        ...
        dialog.setTitle("输入新的文件名");

        final EditText et = new EditText(this);
        dialog.setView(et);

        dialog.setButton(DialogInterface.BUTTON_POSITIVE, "创建",
